wheeltec@wheeltec:~/wheeltec_robot/src$ cat ROS常用功能命令6.0.txt
1.键盘控制
...
//开启沙盘机械臂功能（仅mini麦轮四自由度机械臂小车）
roslaunch wheeltec_arm_pick arm_pick_dp.launch
roslaunch wheeltec_yolo_action dp_drive_moveit.launch
...
23.全覆盖路径规划功能（不推荐阿克曼小车，需要提前建图，并切换DWA导航方式）
第一步：运行命令
roslaunch ipa_room_exploration ipa_room_exploration.launch
第二步：运行rviz，用rviz的publish point工具，顺时针或逆时针点四个点
rviz
------------------------------------------
其它常用命令
